...
public class Kata{
	...
	System.out.println(displayIsEven(userInput));
	displaySquareOf(userInput);
	System.out.println(displayIsSquare(userInput));
	displayFactorialOf(userInput);
	System.out.println(displayIsPalindrome(userInput));
	System.out.println(displayIsPrimeNumber(userInput));
	displaySubtract(userInput, secondUserInput);
	displayDivide(userInput, secondUserInput);
	displayFactorOf(userInput);
	}
	...
	public static void displayFactorOf(int choiceNumber){
	int factor = factorOf(choiceNumber);
	...
	return preferredNumber == resultOfASquaredNumber ? true : false;
	}
